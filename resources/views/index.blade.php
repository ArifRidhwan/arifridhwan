    ...
    <section class="ftco-section">
    	<div class="container-fluid px-4">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4">Our News Blog</h2>
          </div>
		</div>
		<center>
        <div class="row">
        	<div class="col-md-8 col-lg-4 menu-wrap">
		...
		<section class="ftco-section testimony-section img" style="background-image: url({{asset('assets/frontend/images/bg_5.jpg')}})">
			<div class="overlay"></div>
      <div class="container">
